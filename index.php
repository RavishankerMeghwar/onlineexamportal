...
if(isset($_POST['signin'])){
  ...
  $count = mysqli_num_rows($res);
    if($count == 1 && $row['password']==MD5($password)){
        ...
        $errMSG = "Incorrect Username/Password, Try again...";
    }
}
								...
								<div class="tab-content">
									<div id="signin" class="tab-pane in fade active">
										<form action="index.php" method="post" style="padding-left:20px; padding-right:20px"><br><br>
											...
											<div class="form-group"><input style="background-color: #2a73de; color:white; " class="form-control" type="submit" name="signin" value="Sign In"></div>
									...
									<div id="signup" class="tab-pane fade" style="padding-left:20px; padding-right:20px">
										<form action="index.php" method="post"><br><br>
											...
											<div class="form-group" ><input style="background-color: #2a73de; color:white; " class="form-control" type="submit" name="signup" value="Sign Up"></div>
										</form>
									</div>
								</div>
